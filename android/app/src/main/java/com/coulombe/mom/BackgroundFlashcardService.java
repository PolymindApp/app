...
public class BackgroundFlashcardService extends Service {
    ...
    public static final String ACTION_START = "dev.coulombe.mom.flashcards.START";
    public static final String PREFERENCES = "mom_flashcard_speech";
    public static final String KEY_CONFIG = "background_config";
    public static final String KEY_STATE = "background_state";

    private static final String CHANNEL_ID = "mom_flashcard_review";
