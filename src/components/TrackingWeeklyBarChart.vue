...
.chart-legend { margin: .5rem 0; color: rgba(var(--v-theme-on-surface), .68); font-size: .72rem; font-weight: 800; }
...
.chart-readout { min-height: 2.75rem; color: rgba(var(--v-theme-on-surface), .58); font-size: .7rem; }
