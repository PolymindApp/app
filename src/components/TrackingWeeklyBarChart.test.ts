...
describe('TrackingWeeklyBarChart', () => {
  ...
  it('groups each tracker by day and exposes the aggregated values', async () => {
    ...
    expect(wrapper.findAll('.chart-plot, .chart-legend, .chart-readout')[0]?.classes()).toContain('chart-plot')
    expect(wrapper.findAll('.chart-plot, .chart-legend, .chart-readout')[1]?.classes()).toContain('chart-legend')
    expect(wrapper.findAll('.chart-plot, .chart-legend, .chart-readout')[2]?.classes()).toContain('chart-readout')
