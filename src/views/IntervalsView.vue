...
.recent-run-note { display: flex; min-width: 0; align-items: flex-start; gap: .4rem; margin-top: .5rem; color: rgba(var(--v-theme-on-surface), .68); font-size: .75rem; line-height: 1.45; }
