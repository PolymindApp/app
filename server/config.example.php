...
return [
    ...
    'BACKONTRACK_ALLOWED_ORIGINS' => 'https://backontrack.example.com,capacitor://localhost,http://localhost',
    ...
    'BACKONTRACK_WEB_PUSH_VAPID_SUBJECT' => 'mailto:backontrack@example.com',
    'BACKONTRACK_WEB_PUSH_VAPID_PUBLIC_KEY' => 'BASE64URL_PUBLIC_VAPID_KEY',
    'BACKONTRACK_WEB_PUSH_VAPID_PRIVATE_KEY' => 'BASE64URL_PRIVATE_VAPID_KEY',
