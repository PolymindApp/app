...
final class Mailer
{
    ...
    private function htmlTemplate(
        ...
        return '<!doctype html><html lang="en"><body style="margin:0;padding:32px;'
            ...
            . 'style="border-radius:8px;background-color:#C7F464">'
            . '<a href="' . $escape($url) . '" '
            . 'style="display:inline-block;padding:0 6px;border:12px solid #C7F464;'
            . 'border-radius:8px;background:#C7F464;background-color:#C7F464;'
            . 'color:#ffffff !important;font-weight:700;line-height:20px;text-decoration:none">'
            . $escape($action) . '</a></td></tr></table>'
