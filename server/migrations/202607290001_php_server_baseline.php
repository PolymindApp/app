...
return [
    ...
    'up' => static function (\PDO $pdo): void {
        $pdo->exec(<<<'SQL'
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS idx_users_token_key ON users (token_key);
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS idx_tags_owner_name ON tags (owner, name);
            ...
            CREATE INDEX IF NOT EXISTS idx_tasks_owner_active ON tasks (owner, active);
            ...
            CREATE INDEX IF NOT EXISTS idx_program_steps_task_order
                ON program_steps (task, sort_order);
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS idx_occurrences_unique
                ON occurrences (task, program_step, scheduled_date);
            CREATE INDEX IF NOT EXISTS idx_occurrences_owner_date
            ...
            CREATE INDEX IF NOT EXISTS idx_entries_owner_date ON entries (owner, entry_date);
            ...
            CREATE INDEX IF NOT EXISTS idx_interval_templates_owner_order
            ...
            CREATE INDEX IF NOT EXISTS idx_interval_sessions_owner_started
                ON interval_sessions (owner, started_at);
            CREATE INDEX IF NOT EXISTS idx_interval_sessions_owner_status
