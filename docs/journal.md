...
Journal reflections are created and edited in the standard authenticated app shell. On native Android and iOS, focusing the Reflection field expands it across the full usable viewport so the textarea becomes the only editing surface. The textarea scrolls independently for long entries and respects native safe areas.
